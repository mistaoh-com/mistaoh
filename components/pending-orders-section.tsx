          ...
          <div className="space-y-4">
            {pendingOrders.map((order) => (
              <div key={order._id} className="p-4 border rounded-lg bg-white">
                ...
                {/* Total */}
                <div className="text-right font-semibold text-gray-900 mb-4">
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    size="lg"
                    className="w-full bg-[#FF813D] hover:bg-[#e67335] text-white font-bold shadow-lg"
      ...
      <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="flex justify-between items-center pt-4 border-t">
            ...
            <span className="text-lg font-bold text-[#FF813D]">
